export function GoogleButton({ href }: { href: string }) {
  return (
    <a
      href={href}
      className="flex w-full items-center justify-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium text-text-strong transition-colors hover:bg-surface-hover"
    >
